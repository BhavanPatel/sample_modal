/* @BhavanPatel https://github.com/BhavanPatel/jquery-bootstrap-modal-stepwise */
    ...
    $.fn.modalSteps = function(options) {
        ...
        $modal
            .on('show.bs.modal', function() {
                ...
                //Set Title For First Call of Modal
                settings.getTitleAndStep($actualStep.attr('data-title'), actualStep);
        ...
        $modal.find('.js-btn-step').on('click', function() {
            ...
            //Set Title For Every Call of Modal
            settings.getTitleAndStep($nextStep.attr('data-title'), nextStep);
